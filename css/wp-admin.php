...
#adminmenu .menu-icon-dashboard div.wp-menu-image:before {
	content: '\f102';
	margin-top: -1px;
	<?php if( infusion_mobeus_get_option('custom_colour_menu_item_text') !== '' ) { echo('color: '.infusion_mobeus_get_option('custom_colour_menu_item_text').';');}else{ echo('color: #053238;');};?>
}
