...
#wp-admin-bar-view, #wp-admin-bar-my-sites {
	display: none;
}
...
<?php if( infusion_mobeus_get_option('custom_ab_item') !== '' ) { echo('color: '.infusion_mobeus_get_option('custom_ab_item').';');}else{ echo('color: #000;');};?>
	content: '\f228';
...
<?php if( infusion_mobeus_get_option('custom_sec_bg') !== '' ) { echo('border: 1px solid '.infusion_mobeus_get_option('custom_sec_bg').';');}else{ echo('border: 1px solid #A8A8A8;');};?>
<?php if( infusion_mobeus_get_option('custom_sec_bg') !== '' ) { echo('background: '.infusion_mobeus_get_option('custom_sec_bg').';');}else{ echo('background: #A8A8A8;');};?>
<?php if( infusion_mobeus_get_option('custom_sec_bg') !== '' ) { echo('border-left-color: '.infusion_mobeus_get_option('custom_sec_bg').';');}else{ echo('border-left-color: #A8A8A8;');};?>
<?php if( infusion_mobeus_get_option('custom_sec_bg') !== '' ) { echo('border-right-color: '.infusion_mobeus_get_option('custom_sec_bg').';');}else{ echo('border-right-color: #A8A8A8;');};?>
<?php if( infusion_mobeus_get_option('custom_sec_bg') !== '' ) { echo('border-bottom-color: '.infusion_mobeus_get_option('custom_sec_bg').';');}else{ echo('border-bottom-color: #A8A8A8;');};?>
<?php if( infusion_mobeus_get_option('custom_sec_bg') !== '' ) { echo('border-top-color: '.infusion_mobeus_get_option('custom_sec_bg').';');}else{ echo('border-top-color: #A8A8A8;');};?>
	border-radius:4px;
}
